...
if(process.env.NODE_ENV !== 'production'){
	githubClientId = process.env.REACT_APP_GITHUB_CIENT_ID;
	githubClientSecret = process.env.REACT_APP_GITHUB_CIENT_SECRET;
}else{
	githubClientId = process.env.GITHUB_CIENT_ID;
	githubClientSecret = process.env.GITHUB_CIENT_SECRET;
}
